...
class Ga:
    ...
    def cross(self):
        ...
        for i in range(0, individual_num - 1, 2): # individual_num=60
            # 父代基因
    ...
    # 选择2：跨代精英法
    def select2(self):
        father_and_son = self.individual_list # 这是经过变异，两代合并后的种群列表
        # print('这是总种群：')
        # i = 0
        # for i, genes in enumerate(father_and_son):
        #     print('第',i+1,'个基因：', end=' ')
        #     genes.show_genes()
        #     print('个体适应度为：', genes.evaluate_fitness())
        #     i = i + 1

        new_father = Ga.rank(father_and_son) # 经过排名后的种群
        self.individual_list = new_father[:individual_num] # 取出前individual_num个优秀的个体作为新的种群
        # print('这是新种群：')
        # i = 0
        # for i, genes in enumerate(self.individual_list): #for index,linian in enumerate(python):
        #     print('第', i+1, '个基因：', end=' ')
        #     genes.show_genes()
        #     print('个体适应度为：',genes.evaluate_fitness())
        #     i = i + 1
